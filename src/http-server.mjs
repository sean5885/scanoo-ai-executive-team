...
function normalizeUserResponseList(items = []) {
  return [...new Set(
...
function buildPlannerSuccessUserResponse(envelope = {}) {
...
function normalizeUserResponse({
  ...
  if (envelope) {
    const failureReply = buildPlannedUserInputUserFacingReply(plannerResult || envelope);
    if (failureReply) {
      return {
        ok: false,
