...
- Current truth:
  ...
  - `planner/action-loop.mjs` currently provides a minimal standalone action executor (`send_message`) and returns a bounded `no_action | action_executed | unsupported_action` shape
